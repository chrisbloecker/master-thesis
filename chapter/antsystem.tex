...
\nomenclature[515]{$\tau^+_i$\dotfill}{Pheromone amount to be deposited by ant $i$}
...
\section{A prototype of a distributed ant system\index{Ant System}}
