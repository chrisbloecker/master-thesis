...
\begin{theorem}[$Id$ is a left and right neutral element for sequence composition]
...
\begin{myproof}[$Id$ is a left and right neutral element for sequence composition]
...
Now consider the case that $Q$ is a sub-process of $P$ and distinguish between its structural properties:
\begin{enumerate}
...
\end{enumerate}
In all cases, $P \equiv P_{\left[ Q / R \right]}$ holds an thus, \thmref{thm:substitution_equivalence} is valid.
