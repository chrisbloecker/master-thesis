...
Let $R \in \mathcal{P}$ be a process and let the \textsc{Kleene} star $*$ be applied to $R$, i.e. $R^*$. The semantics of $R^*$ is then directly derived from \defref{def:syn_kleene} and \defref{def:sem_choice}.
  \begin{equation}
