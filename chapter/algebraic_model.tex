...
\label{chp:syntax}
Let $\mathcal{P}$ be the set of processes\index{Process} and let $P, Q \in \mathcal{P}$ be basic processes. $\mathcal{P}$ represents the set of computable functions\index{Function} in form of processes and hence is countable\footnote{ToDo}. Then syntactically correct processes can be formed inductively by:
\begin{itemize}
