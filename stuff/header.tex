...
\newcommand{\untertitel}{A process algebra for distributed programming in Haskell}
\newcommand{\Datum}{January 31, 2015}
...
\newcommand{\sequence}{\triangleright}
\newcommand{\repetition}{*}
