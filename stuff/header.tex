...
\newcommand{\thesisname}{Master's Thesis}
\newcommand{\projname}{\authorname~-~\titel~-~\thesisname}
\newcommand{\untertitel}{}
%\newcommand{\Datum}{$2^\text{nd}$ of March 2015}
\newcommand{\Datum}{March 2, 2015}
...
\newcommand{\sem}[1]{sem \left\langle #1 \right\rangle}
